...
Setting up the GSLT token is very important if you want your server to be publicly listed on the server list. It’s thankfully very easy and simple to add and this guide will show you how to do it on your EclipseNode server!
